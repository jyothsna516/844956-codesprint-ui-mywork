function validate() {
    ...
    if(a==""){alert("plz enterthe amount");document.getElementById("t1").focus();
    return false;}
    ...
    if(b==""){alert("please Enter your street address");
    document.getElementById("t5").focus();
    return false;}
    
    var b = document.getElementById("t6").value;
    if(b==""){alert("please Enter your city");
    ...
    if(b==""){alert("please Enter your state");
...
function movetoNext(current, nextFieldID) {
    ...
    else{alert("please enter the 10 digit number in range of 0 to 9");
}
}